...
/*
이름 : 문자열
나이 : 정수, 나이는 1 ~ 199를 정상 입력으로 간주 이외의 값이 오면 재 입력 요구
...
public class MemberInfo {
        ...
        public void setAge() {
            while (true) {
                ...
                age = sc.nextInt();
                if (age > 0 && age < 200) return; // break를 써도 되지만 break는 while 끝나는 지점에 뭐가 또 있으면 다시 돌아가서 한번 더 수행한다. return은 메소드 그 친 그 지점에 끝난다.
        ...
        public void setJobs() {
            while (true) {
                ...
                else System.out.println("직업을 잘 못 입력 하셨습니다.");
            }
        }
