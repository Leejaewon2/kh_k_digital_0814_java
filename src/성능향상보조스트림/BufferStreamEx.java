...
/*
프로그램과 입출력 장치  사이에는 엄청난 속도 차이가 발생하며, 이로 인해서
병목현상이 발생 합니다.
...
//        fis = new FileInputStream("src/성능향상보조스트림/루피2.jpg");
//        bis = new BufferedInputStream(fis);
//        fos = new FileOutputStream("d:/tmp/루피2번.jpg");
...
//        System.out.println("성능향상 보조 스트림을 사용하지 않은 경우 : " + (end - start + "ms"));
        ...
        fis = new FileInputStream("src/성능향상보조스트림/루피2번.jpg");
        bis = new BufferedInputStream(fis);
        fos = new FileOutputStream("d:/tmp/루피2번.jpg");
