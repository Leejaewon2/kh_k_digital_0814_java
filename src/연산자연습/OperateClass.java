...
//        System.out.println("뼬셈 : " + (num1 - num2));
//        System.out.println("곱셈 : " + (num1 * num2));
//        System.out.println("나눗셈 : " + ((double)num1 / num2));
//        System.out.println("나머지 : " + (num1 % num2));
//        System.out.println("몫 : " + (num1 / num2));

        // 대입 연산자 : 변수에 값을 대입하는 연산자 ( = ), 프로그램에서 = 같다라는 의미가 아니고 값을 대입한다는 의미
...
//        System.out.println(++num1); // 11, 전휘 연산자
//        System.out.println(num1++); // 10, 후위 연산자
//        int tmp = ++num1;
...
//        int tmp = num1++;
//        System.out.println(tmp); //11
//        System.out.println(num1); //num1++ 후위연산자 이기 때문에 후에 더 하기 때문에 11

        // 비교 연산자 : 두개의 피연산자를 비교해서 어느쪽이 큰지를 판단ㄷ
        int x = 10;
        int y = 20;
...
//        System.out.println(rst1 + " " + rst2 +" " + rst3);
        ...
        int age = sc.nextInt();
        boolean isAudlt = (age > 19) ? true : false;
        sc.nextLine();
