...
public class DataTypeClass {
    public static void main(String[] args) {
        int age; //정수형 변수 선언 4바이트(32bit) 공간을 확보 하고 초기값은 아직 없음, 정수값(소수점 이하가 없음)을 저장하는 목적
        double value; // 실수값을 저장하기 위한 변수 선언

        char gender = 'M'; // (2바이트) 선언과 동시에 초기화, gender 라는 변수에 문자 M을 대입 한다는 의미

        // 논리형 변수 선언 : 참과 거짓을 판별하기 위해서 사용하는 자료형
        boolean isTrue; // true, flase의 예약어만 사용 할 수 있음

        // 정수형 변수 선언 : 소수점 이하가 없고 양수와 음수가 존재
        byte bNum;  // 1 Byte 크기의 변수 선언 1 Byte ==8bit (-128 ~ +127)
