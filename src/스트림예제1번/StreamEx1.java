...
//        int sumVal = list.stream().reduce(0, Integer::sum(); // reduce로 합계구하는 방법
//        int count = (int) list.stream().count(); // 카운트 방법 1
        int count = list.size(); // 카운트 방법 2
        System.out.print("합계 : " + sumVal);
